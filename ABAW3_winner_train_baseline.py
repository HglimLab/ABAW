...
if __name__ == '__main__':
    ...
    ### pos_weight은 레이블분류에 사용되는 BCEWithLogitsLoss의 W 값임
    ...
    def AU_metric_loss(AU_embedding, y):
        ...
        """
### Loss function에의한 발전에 속하고 그 중에서 verification loss function에 해당. 간단히 말하면 무작위 데이터셋을 뽑은후
### positive pair와 negative 를 sample한후 positive는 가까이, negative는 멀리 배치하는 방법
